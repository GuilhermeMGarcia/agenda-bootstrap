...
SECRET_KEY = 'django-insecure-g_bv@ud-u#3zg7vj994vd@sj=yumy^d9akbs$hkwlkx3ctz4(r'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'contatos/templates/contatos',
            BASE_DIR / 'contatos/templates/contatos/parciais',
